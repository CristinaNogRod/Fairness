...
def run_experiment(
    dataset_path='datasets/proc/crafted_credit.csv',
    report_path='outputs/report_credit.json'
):
    ...
    _, _ = model.fit(X_train, pv_train, batch_size=1024, epochs=100, val_X=None, val_pv=None)
